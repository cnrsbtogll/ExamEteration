...
const Typography = props => {
  ...
  const textStyles = StyleSheet.flatten([
    ...
    //bold && { fontFamily: 'Arial-Regular' },
    bold && {
      fontWeight: Platform.OS === 'ios' ? WEIGHTS.bold : 'normal',
    },
    medium && {
      fontWeight: Platform.OS === 'ios' ? WEIGHTS.semibold : 'normal',
    },
    notera && {
      fontFamily: Platform.OS === 'ios' ? 'NoteraPersonalUseOnly' : 'Notera',
    },
